...
func (s *Server) registerRoutes() {
	...
	s.router.POST("/api/auth/logout", s.withAuth(true, s.handleLogout))
	s.router.POST("/api/auth/refresh", s.withAuth(false, s.handleRefresh))
	...
	s.router.GET("/api/cart", s.withAuth(true, requireRole(domain.RoleConsumer, s.handleCart)))
	s.router.POST("/api/cart/items", s.withAuth(true, requireRole(domain.RoleConsumer, s.handleCartItems)))
	...
	s.router.PUT("/api/merchant/products/:id", s.withAuth(true, requireMerchant(s.handleMerchantProductByID)))
	s.router.POST("/api/merchant/products/:id/skus", s.withAuth(true, requireMerchant(s.handleMerchantProductByID)))
	s.router.POST("/api/merchant/products/:id/online", s.withAuth(true, requireMerchant(s.handleMerchantProductByID)))
	s.router.POST("/api/merchant/products/:id/offline", s.withAuth(true, requireMerchant(s.handleMerchantProductByID)))
	s.router.PUT("/api/merchant/skus/:id", s.withAuth(true, requireMerchant(s.handleMerchantSKUByID)))
	s.router.GET("/api/merchant/orders", s.withAuth(true, requireMerchant(s.handleMerchantOrders)))
	s.router.GET("/api/merchant/orders/:id", s.withAuth(true, requireMerchant(s.handleMerchantOrderByID)))
	s.router.POST("/api/merchant/orders/:id/ship", s.withAuth(true, requireMerchant(s.handleMerchantOrderByID)))
	s.router.POST("/api/merchant/orders/:id/refund/approve", s.withAuth(true, requireMerchant(s.handleMerchantOrderByID)))
	s.router.GET("/api/merchant/dashboard/funnel", s.withAuth(true, requireMerchant(s.handleMerchantDashboardFunnel)))
